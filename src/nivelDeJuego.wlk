...
object nivelUno inherits Nivel{
	...
	override method cargarEnemigos() {
		...
		11.times({i => 
			...
			enemigos.add(new Enemigo2 (position = game.at(i+1,10), image = "invader2.gif", posicionDerecha = i+2, posicionIzquierda = i, puntos = 100))
...
object nivelDos inherits Nivel{
	...
	override method cargarEnemigos() {
		...
		7.times({i => 
			...
			enemigos.add(new Enemigo2 (position = game.at(i+3,7), image = "invader2.gif", posicionDerecha = i+4, posicionIzquierda = i+2, puntos = 100))
...
object nivelTres inherits Nivel{
	...
	override method cargarEnemigos() {
		...
		4.times({i =>
			...
			enemigos.add(new Enemigo2 (position = game.at(10,14-i), image = "invader2.gif", posicionDerecha = 11, posicionIzquierda = 9, puntos = 100))
		...
		3.times({i =>
			...
			enemigos.add(new Enemigo2 (position = game.at(12,14-i), image = "invader2.gif", posicionDerecha = 13, posicionIzquierda = 11, puntos = 100))
		})
		2.times({i =>
			...
			enemigos.add(new Enemigo2 (position = game.at(11,15-2*i), image = "invader2.gif", posicionDerecha = 12, posicionIzquierda = 10, puntos = 100))
			...
			enemigos.add(new Enemigo2 (position = game.at(9,7-i), image = "invader2.gif", posicionDerecha = 10, posicionIzquierda = 8, puntos = 100))
			enemigos.add(new Enemigo2 (position = game.at(10,9-i), image = "invader2.gif", posicionDerecha = 11, posicionIzquierda = 9, puntos = 100))
			enemigos.add(new Enemigo2 (position = game.at(11,11-3*i), image = "invader2.gif", posicionDerecha = 12, posicionIzquierda = 10, puntos = 100))
		})
		...
		enemigos.add(new Enemigo2 (position = game.at(9,8), image = "invader2.gif", posicionDerecha = 10, posicionIzquierda = 8, puntos = 100))
		enemigos.add(new Enemigo2 (position = game.at(10,5), image = "invader2.gif", posicionDerecha = 11, posicionIzquierda = 9, puntos = 100))
